...
type BadgeProps = ViewProps & { className?: string; variant?: BadgeVariant };
...
const styles = StyleSheet.create({
  ...
  textBase: { fontSize: 12, fontWeight: "600", lineHeight: 14 },
});

function getContainerStyle(variant: BadgeVariant, theme: ReturnType<typeof useRegistryTheme>): ViewStyle {
  switch (variant) {
    case "secondary": return { backgroundColor: theme.secondary, borderColor: "transparent" };
    case "destructive": return { backgroundColor: "rgba(239, 68, 68, 0.12)", borderColor: "transparent" };
    case "outline": return { backgroundColor: theme.background, borderColor: theme.border };
    default: return { backgroundColor: theme.primary, borderColor: "transparent" };
  }
}
