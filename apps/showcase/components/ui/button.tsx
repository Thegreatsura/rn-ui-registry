...
function getButtonStyle(variant: ButtonVariant, theme: ReturnType<typeof useRegistryTheme>): StyleProp<ViewStyle> {
  switch (variant) {
    case "destructive":
      return { backgroundColor: "rgba(239, 68, 68, 0.12)", borderColor: "transparent", borderWidth: 1 };
    case "outline":
      return { backgroundColor: theme.background, borderColor: theme.border, borderWidth: 1 };
    case "secondary":
      return { backgroundColor: theme.secondary, borderColor: "transparent", borderWidth: 1 };
    case "ghost":
    ...
    default:
      return { backgroundColor: theme.primary, borderColor: "transparent", borderWidth: 1 };
  }
}
...
function getButtonTextStyle(variant: ButtonVariant, theme: ReturnType<typeof useRegistryTheme>): TextStyle {
  switch (variant) {
    ...
    case "outline": return { color: theme.foreground };
    case "secondary": return { color: theme.secondaryForeground };
    case "ghost": return { color: theme.foreground };
    case "link": return { color: theme.primary, textDecorationLine: "underline" };
    default: return { color: theme.primaryForeground };
  }
}
...
function getSizeStyle(size: ButtonSize): StyleProp<ViewStyle> {
  switch (size) {
    ...
    default: return styles.mdButton;
  }
}
...
const styles = StyleSheet.create({
  ...
  mdButton: { gap: 6, minHeight: 32, paddingHorizontal: 10, paddingVertical: 6 },
  smButton: { gap: 4, minHeight: 28, paddingHorizontal: 10, paddingVertical: 4 },
  lgButton: { gap: 6, minHeight: 36, paddingHorizontal: 12, paddingVertical: 8 },
  iconButton: { height: 32, justifyContent: "center", paddingHorizontal: 0, width: 32 },
  pressed: { opacity: 0.96, transform: [{ translateY: 1 }] },
  ghostPressed: { backgroundColor: "rgba(0,0,0,0.04)" },
  disabled: { opacity: 0.5 },
  buttonTextBase: { fontSize: 14, fontWeight: "500", lineHeight: 18 },
});
